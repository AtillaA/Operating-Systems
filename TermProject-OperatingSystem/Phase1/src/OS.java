...
public class OS extends Thread {
	...
	public void loadProcessList(String processListFile)
	{
		this.fileInputProducer = new FileInputProducer(mutex, fileInputQueue, processListFile, assembler);
